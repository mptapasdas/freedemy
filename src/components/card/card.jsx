          ...
          <div className="bottom-row d-flex flex-row mt-auto">
            ...
            {liked ? (
              <button
                ...
                className={`fa fa-star star-liked star-hover favorite-button " + ${
                  favoriteDisabled ? "reduce-opacity" : ""
                }`}
              ...
              <button
                disabled={favoriteDisabled}
                className={`far fa-star star-default star-hover favorite-button " + ${
                  favoriteDisabled ? "reduce-opacity" : ""
                }`}
                onClick={() => likeHandler()}
              ></button>
